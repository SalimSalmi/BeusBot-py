...
class Music:
    """Every night is now Friday dj night! :notes:
    ...
    async def joinChannel(self, ctx, *, channel : discord.Channel):
        ...
        try:
            ...
            await self.bot.say('Joining ' + channel.name)
    ...
    async def join(self, ctx):
        ...
        if state.voice is None:
            state.voice = await self.bot.join_voice_channel(joined_channel)
        else:
            await state.voice.move_to(joined_channel)
